...
xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <NamedLayer>
    <Name>VMEAREAS_Public</Name>
    <UserStyle>
      
      <Title>Public VMEAREAS</Title>
      <Abstract>List all the public VME areas</Abstract>
      ...
      <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <ogc:Filter>
            ...
            <ogc:PropertyIsNotEqualTo>
                ...
                <ogc:Literal>WECAFC</ogc:Literal>
            </ogc:PropertyIsNotEqualTo>
            <ogc:PropertyIsNotEqualTo>
                <ogc:PropertyName>OWNER</ogc:PropertyName>
        ...
        <!-- backup of the above ctreated on 24-04-2014 by FC
        <Rule>
          <Name>Rule 1</Name>
       ...
       <!-- Temporary rule to includ WECAFC and SPRFMO competence area as clickable areas-->
        ...
        <Rule>
          <Name>Rule 4</Name>
          <!--Title>VME (Adopted)</Title-->
          <Title>Competence area</Title>
          <Abstract>50% transparent grey fill without outline</Abstract>
          <ogc:Filter>
        <ogc:And>
            <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>STATUS</ogc:PropertyName>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#f0f8ff</CssParameter>
