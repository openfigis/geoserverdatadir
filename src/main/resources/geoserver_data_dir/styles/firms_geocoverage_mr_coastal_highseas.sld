...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>FIRMS MR qualitative coverage</Name>
    <UserStyle>
      <Title>FIRMS MR qualitative coverage</Title>
      <Abstract>Gives the symbology of MR qualitative FIRMS coverage for both coastal and highseas resources</Abstract>
            ...
            <ogc:And>
              ...
              <ogc:Or>
                <ogc:PropertyIsGreaterThan>
                  <ogc:PropertyName>MR_COUNT</ogc:PropertyName>
                  <ogc:Literal>0</ogc:Literal>
                </ogc:PropertyIsGreaterThan>
                <ogc:PropertyIsGreaterThan>
                  <ogc:PropertyName>MR_EST</ogc:PropertyName>
                  <ogc:Literal>0</ogc:Literal>
                </ogc:PropertyIsGreaterThan>
              </ogc:Or>
              <ogc:Or>
