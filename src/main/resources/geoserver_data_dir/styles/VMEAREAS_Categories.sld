    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <!--<Abstract>100% transparent fill with a lightbluew outline 1 pixel in width</Abstract>-->
          <Abstract>35% transparent fill with a lightgray without outline</Abstract>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>STATUS</ogc:PropertyName>
          ...
          <PolygonSymbolizer>
            ...
            <!--<Stroke>
              <CssParameter name="stroke">#00F000</CssParameter>
