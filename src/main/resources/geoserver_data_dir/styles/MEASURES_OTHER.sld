...
xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <NamedLayer>
    <Name>MEASURES_OTHER</Name>
    <UserStyle>
      
      <Title>Global style for Areas with other access regulations</Title>
      <Abstract>Global Style for Areas with other access regulations</Abstract>
      
      <FeatureTypeStyle>
 
        <Rule>
          <Name>Rule 1</Name>
          <Title>Areas with other access regulations</Title>
          <Abstract></Abstract>
          <PolygonSymbolizer>
            <Stroke>
